...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="css/funcionario-relatorio-compra1.css">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                            <th scope="row"><?php echo $dado["codigo_venda"]; ?></th>
                            <td><?php echo $dado["descricao_venda"]; ?></td>
                            <td><?php echo date ("d/m/Y", strtotime($dado["data_venda"])); ?></td>
                            <td><?php echo $dado["valorfinal"]; ?></td>
