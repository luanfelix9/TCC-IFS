...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" href="css/gerente-relatorio-funcionario1.css">
                ...
                <div class="col-md-12">
                    ...
                    <table class="table">
                        <thead>
                            ...
                            <th scope="col">Data da Admição</th>
                        ...
                        <tbody>
                            <tr>
                            <th scope="row"><?php echo $dado["cpf"]; ?></th>
                            <td><?php echo $dado["nome_funcionario"]; ?></td>
                            <td><?php echo $dado["email_funcionario"]; ?></td>
                            <td><?php echo $dado["endereco"]; ?></td>
                            <td><?php echo date ("d/m/Y", strtotime($dado["data_admissao"])); ?></td>
                            <td><?php echo date ("d/m/Y", strtotime($dado["data_demissao"]));?></td>
