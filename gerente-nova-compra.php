...
<html lang="pt-BR">
    <head>
        ...
        <link rel="stylesheet" href="css/gerente-nova-compra1.css">
        ...
        <div class="container">
            <div class="row">
                ...
                <table class="table">
                    ...
                    <form action="comprafinal.php" method="post" class="row g-3">     
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary" name="entrada">Finalizar Compra</button>
                    </div>
            </div>
        </div>
    </body>
